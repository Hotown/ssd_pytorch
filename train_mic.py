...
parser.add_argument('--dataset', default='MIC', choices=['VOC', 'COCO', 'WIDER', 'MIC'],
                    type=str, help='VOC or COCO')
parser.add_argument('--dataset_root', default=MIC_ROOT,
...
def train():
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if iteration != 0 and iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights/ssd300_MIC_' +
                       repr(iteration) + '.pth')
