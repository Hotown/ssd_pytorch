...
def train():
    ...
    if args.dataset == 'COCO':
        if args.dataset_root == VOC_ROOT or args.dataset_root == WIDER_ROOT:
        ...
        if args.dataset_root == COCO_ROOT or args.dataset_root == WIDER_ROOT:
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if iteration != 0 and iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights/ssd300_WIDER_' +
                       repr(iteration) + '.pth')
